        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <form className="space-y-6" onSubmit={handlePasswordChange}>
            ...
            <div>
              <button
                type="submit"
                className="flex w-full justify-center rounded-md bg-blue-500 dark:bg-purple-400 px-3 py-1.5 text-sm font-semibold text-white shadow-sm hover:bg-blue-600 dark:hover:bg-purple-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2"
              >
                Change Password
              </button>
            </div>
