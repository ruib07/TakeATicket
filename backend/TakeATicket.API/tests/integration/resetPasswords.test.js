...
test("Test - Should send a email to reset password when user exists", async () => {
...
test("Test - Should return success even if the user does not exist", async () => {
  const response = await supertest(app)
    .post(`${route}/${sendEmailRoute}`)
    .send({
...
test("Test - Should change password when user put valid credentials", async () => {
...
test("Test - Should return error message when passwords are mismatched", async () => {
...
test("Test - Should return error message when token is expired", async () => {
...
test("Test - Should return error message when token is invalid", async () => {
  const changePassword = generateChangePassword();
